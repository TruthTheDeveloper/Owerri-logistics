  ...
  return (
    <Layout>
        <div style={{background:'#F3F4F6'}} className="overflow-hidden">
            ...
            <div className="bg-white mx-8 sm:mx-16 my-8 shadow-lg pt-16">
                <div className="flex px-8 sm:px-24">
                    ...
                    <div className="basis-1/3 border-t-4 border-slate-200">
                        <div style={{marginTop:'-1rem'}} className=" mx-auto py-1 w-8   z-10 rounded-full bg-white border-slate-200 border text-slate-400  text-center text-sm">2</div>
                        <h1 className="text-sm text-center my-4">Shipment details</h1>
                    </div>
                    <div className="basis-1/3 border-t-4 border-slate-200">
                        <div style={{marginTop:'-1rem'}} className=" mx-auto py-1 w-8    z-10 rounded-full bg-white border-slate-200 border text-slate-400   text-center text-sm">
                            3
                        </div>
                        <h1 className="text-sm text-center my-4">Upload item</h1>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row md:justify-between  mx-6 sm:mx-16">
                    <div className="flex flex-col  py-2">
                        <label className="mb-2 ml-8">Pickup Address</label>
                        <div className="flex" >
                            <span className="mx-2"><FontAwesomeIcon icon={faDirections}  /></span>
                            <input className="h-10 p-4 placeholder:text-sm w-full placeholder:pl-2 outline-none bg-slate-100 rounded-md" placeholder="Pickup Address"/>
                        </div>
                    </div>
                    <div className="flex flex-col py-2">
                        ...
                        <div className="flex">
                            ...
                            <input className="h-10 p-4 w-full placeholder:text-sm placeholder:pl-2 outline-none mb-4 bg-slate-100 rounded-md" placeholder="Delivery Address"/>
                        </div>
                    </div>
                </div>
