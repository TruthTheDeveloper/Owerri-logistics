        ...
        <div className="mt-24 mb-12">
            ...
            <div className="grid grid-rows-1 lg:grid-cols-3">
                <div className="shadow-xl mx-12  bg-slate-100 my-6 h-max hover:bg-green-500 hover:text-white" >
                    <div className="pl-8 my-3 h-24 w-24"><FontAwesomeIcon icon={faPersonBiking} size="2x"/></div>
                ...
                <div className="shadow-xl  mx-12 bg-slate-100 my-6 h-max hover:bg-green-500 hover:text-white">
                    <div className="pl-8 my-3 h-24 w-24"><FontAwesomeIcon icon={faStore} size="2x"/></div>
                ...
                <div className="shadow-xl mx-12 bg-slate-100 my-6 h-max hover:bg-green-500 hover:text-white">
                    <div className="pl-8 my-3 h-24 w-24 "><FontAwesomeIcon icon={faCheckDouble} size="2x"/></div>
